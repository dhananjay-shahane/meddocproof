...
import { Loader2, Mail, Lock, ArrowLeft, UserPlus, Eye, EyeOff } from "lucide-react";
...
const testimonials: Testimonial[] = [
  {
    name: "Dr. Anil Kumar",
    handle: "General Physician",
    text: "The platform makes reviewing and issuing medical certificates seamless and efficient.",
  },
  {
    name: "Dr. Sarah Smith",
    handle: "Senior Consultant",
    text: "Easy to manage patient consultations and issue certificates from anywhere.",
  },
];
...
function DoctorLoginContent() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await api.post("/auth/doctor/forgot-password", { email });
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await api.post("/auth/doctor/reset-password", {
        token: resetToken,
  ...
  const getSubtitle = () => {
    switch (view) {
      ...
      default:
        return "Sign in to your doctor account";
    }
  };
  ...
  return (
    <div className="auth-gradient-bg min-h-screen">
      <SignInPage
        title={
          <>
            <span className="text-primary">Doctor</span> Portal
          </>
        }
        description={getSubtitle()}
        heroImageSrc="/images/auth/doctor-hero.jpg"
