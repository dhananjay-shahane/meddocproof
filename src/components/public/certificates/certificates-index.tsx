...
export function CertificatesIndex() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50 pt-24 lg:pt-32 pb-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionReveal blur={true} scale={true}>
          <div className="text-center mb-12">
            <span className="inline-block text-sm font-medium text-blue-600 mb-3 tracking-wide">
              Our Services
            </span>
            ...
            <p className="text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Browse our complete range of medical certificates. Each certificate type has its own dedicated page with detailed information. All certificates are issued by certified doctors through a quick and convenient online consultation.
            </p>
          </div>
        </SectionReveal>
        ...
        <FadeIn delay={0.2}>
          <div className="text-center mt-12">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-teal-500 hover:from-blue-700 hover:to-teal-600 text-white font-semibold py-3.5 px-8 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl"
            >
