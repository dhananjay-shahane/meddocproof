      ...
      >
        ...
        >
          <div className="absolute inset-0 animate-spin-slow">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1557683316-973673baf926?w=2048&auto=format&fit=crop&q=60"
                alt=""
          ...
          <div className="absolute inset-0 animate-spin-slow-reverse">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=1024&auto=format&fit=crop&q=60"
                alt=""
        ...
        <div className="relative z-20 w-full h-full flex flex-col items-center justify-end pb-24 gap-6">
          <div className="w-16 h-16 rounded-2xl shadow-lg overflow-hidden mb-2 ring-1 ring-white/10">
            <img
              src="https://images.unsplash.com/photo-1684369175833-4b445ad6bfb5?q=80&w=400&auto=format&fit=crop"
              alt="App Icon"
          ...
          <div className="w-full max-w-md px-4 mt-4 h-15 relative">
            <canvas
              ref={canvasRef}
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 pointer-events-none z-50"
            />
            ...
            >
              <input
                ...
                className="w-full h-15 pl-6 pr-37.5 rounded-full outline-none transition-all duration-200 placeholder-zinc-500 disabled:opacity-70 disabled:cursor-not-allowed"
                style={{
              ...
              <div className="absolute top-1.5 right-1.5 bottom-1.5">
                <button
                  type="submit"
                  disabled={status === "loading"}
                  className="h-full px-6 rounded-full font-medium text-white transition-all active:scale-95 hover:brightness-110 disabled:hover:brightness-100 disabled:active:scale-100 disabled:cursor-wait flex items-center justify-center min-w-32.5"
